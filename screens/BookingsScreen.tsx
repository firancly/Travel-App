...
const styles = StyleSheet.create({
  ...
  tabText: { fontFamily: fonts.interMedium, fontSize: 12, color: colors.textSecondary },
  ...
  stepValue: { fontFamily: fonts.jakartaBold, fontSize: 20, color: colors.textPrimary, minWidth: 28, textAlign: 'center' },
